...
namespace GLaDOSV3.Helpers
{
    public static class PInvokes // Original source found: https://pastebin.com/7qtiPv3A
    {
        ...
        /// </summary>
        public static T GetFunction<T>(nint module, string name)
        {
        ...
        /// </summary>
        public static T GetFunction<T>(nint module) => GetFunction<T>(module, typeof(T).Name);

        /// <summary>
        /// Get the pointer to a module
        /// </summary>
        public static nint GetModule(string name)
        {
        ...
        public static Delegate GetDelegate<T>(nint module, string name)
        {
        ...
        [DllImport("kernel32.dll", EntryPoint = "LoadLibrary", SetLastError = true, CharSet = CharSet.Ansi)]
        private static extern nint GetModulePtr(string libraryFile);

        [DllImport("kernel32.dll", EntryPoint = "GetProcAddress", SetLastError = true, CharSet = CharSet.Ansi)]
        private static extern nint GetFunctionPtr(nint hModule, string procedureName);
    }
    public static class PInvokesDllImport
    {
        [DllImport("kernel32.dll", EntryPoint = "SetDllDirectory", SetLastError = true, CharSet = CharSet.Ansi)]
